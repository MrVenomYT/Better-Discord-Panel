function versionCompare(current, latest, options) {
  ...
  for (let i = 0; i < currentparts.length; ++i) {
    ...
    if (currentparts[i] == latestparts[i]) {
      ...
      successNotification('<a href=\'https://github.com/MrVenomYT/BetterDiscordPanel/releases/tag/2.6.2\' target=\'_blank\'>New update available!</a>');
